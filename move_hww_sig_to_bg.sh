...
cd LIMITS-131128-hww/hww-sig-float/cmb/$MASS
...
combine -M MaxLikelihoodFit -m $MASS  --robustFit=1 --preFitValue=1. --X-rtd FITTER_NEW_CROSSING_ALGO --minimizerAlgoForMinos=Minuit2 --minimizerToleranceForMinos=0.1 --X-rtd FITTER_NEVER_GIVE_UP --X-rtd FITTER_BOUND --minimizerAlgo=Minuit2 --minimizerStrategy=0 --minimizerTolerance=0.1 --cminFallbackAlgo "Minuit2,0:1."  --rMin -5 --rMax 5  --justFit  ./workspace.root --out=out
